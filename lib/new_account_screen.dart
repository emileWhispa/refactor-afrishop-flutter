            ...
            child: CupertinoButton(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(child: Text("Sign in with Google",textAlign: TextAlign.center,style: TextStyle(fontSize: 15.5,color: Colors.black87.withOpacity(0.60),fontFamily: 'SF UI Display',fontWeight: FontWeight.bold),)),
                ],
              ),
            ...
            child: CupertinoButton(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(child: Text("Sign in with Facebook",textAlign: TextAlign.center,style: TextStyle(fontSize: 15.5,color: Colors.black87.withOpacity(0.60),fontFamily: 'SF UI Display',fontWeight: FontWeight.bold),)),
                ],
              ),
              onPressed: _faceBook,
              color: Color(0xffffe707),
            ...
            child: CupertinoButton(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(child: Text("Sign in with Phone number",textAlign: TextAlign.center,style: TextStyle(fontSize: 15.5,color: Colors.black87.withOpacity(0.60),fontFamily: 'SF UI Display',fontWeight: FontWeight.bold),)),
                ],
              ),
              onPressed: () async {
                var str = await Navigator.of(context).push(
                    CupertinoPageRoute<FirebaseUser>(
                        builder: (context) => Authorization(pop: true,)));
